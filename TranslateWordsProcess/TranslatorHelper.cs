...
namespace TranslateWordsProcess
{
    public class TranslatorHelper
    {
        ...
        public TranslatorHelper(IConfiguration appConfig, string outputLanguage)
        {
            ...
            translator = new Translator(appConfig["deepl.key"]??throw new InvalidOperationException("Unable to find deep.key in appsettings!"));
            deepLLog = bool.Parse(appConfig["deepl.log"] ?? false.ToString());
